...
OPENROUTESERVICE_API_KEY='YOUR_OPENROUTESERVICE_SECRET_KEY'
...
Note: That the Depo Location is a singleton meaning only one value can be stored in there at once.
