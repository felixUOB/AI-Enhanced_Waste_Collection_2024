...
from ewc_core.ml_model.data import export_stopcollection_csv
...
urlpatterns = [
    ...
    path('api/export_stopdata', export_stopcollection_csv, name='export_stopdata'), # Export Stop collection data to csv
