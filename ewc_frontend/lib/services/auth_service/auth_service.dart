...
class AuthService {
  ...
  final String apiUrl = 'http://128.0.0.1:8000/api';
  final String adminUrl = 'http://128.0.0.1:8000/admin';
...
void launchPasswordReset() async {
  final Uri resetUri = Uri.parse("http://128.0.0.1:8000/reset_password/");
