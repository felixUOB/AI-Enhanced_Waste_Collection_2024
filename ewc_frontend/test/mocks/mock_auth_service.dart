...
class MockAuthService extends Mock implements AuthService {
  @override
  Future<http.Response> makeAuthenticatedRequest(String? endpoint) => super.noSuchMethod(
  ...
  @override
  Future<http.Response> makeAuthenticatedPostRequest(String endpoint, Map<String, dynamic>? body) => super.noSuchMethod(
